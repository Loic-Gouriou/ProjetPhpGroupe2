            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="special-menu text-center">
                        ...
                        <div>
                            <?php
                            $query2 = $db->prepare('SELECT A.article_id, A.article_img, A.article_nom, A.article_prix, A.article_prixSolde, A.article_description, A.article_stock, C.categorie_id FROM Article as A, Categorie as C WHERE A.categorie_id = C.categorie_id AND C.categorie_nom LIKE "Fruits" ORDER BY categorie_id');
                            $query2->execute();
