            ...
            <div class="row">
                <div class="col-lg-8 col-sm-12">
                    <div class="contact-form-right">
                        <h2>GET IN TOUCH</h2>
                        <p>Veuillez dire ce qui va pas, oubliez pas l'adresse pour qu'on vienne chez vous et tout casser</p>
                        <form id="contactForm">
                            <div class="row">
                                <div class="col-md-12">
                ...
                <div class="col-lg-4 col-sm-12">
                    <div class="contact-info-left">
                        <h2>CONTACT INFO</h2>
                        <p>Pour communiqué avec LA MEILLEURE equipe de fruits et légumes</p>
                        <ul>
                            <li>
