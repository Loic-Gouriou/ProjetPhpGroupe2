        ...
        <ul class="slides-container">
            <li class="text-center">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Bienvenue sur <br> Freshshop</strong></h1>
                            <p class="m-b-40">Le meilleur site pour acheter c'est fruit à l'unité, <br> sacher que nos Abricots confits sont les meilleurs du marchés.</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        ...
                        <a class="btn hvr-hover" href="#">Légumes</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="images/categories_img_03.jpg" alt="" />
                        <a class="btn hvr-hover" href="#">Fruits secs</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="images/categories_img_03.jpg" alt="" />
                        <a class="btn hvr-hover" href="#">Fruits confits</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-all text-center">
                        <h1>latest blog</h1>
                        <p>Bah y'en a pas parce que c'est pas le but du projet</p>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="blog-box">
                        ...
                        <div class="blog-content">
                            <div class="title-blog">
                                <h3>Ancien blog inexistant n1</h3>
                                <p>Ceci parle de rien</p>
                            </div>
                ...
                <div class="col-md-6 col-lg-4 col-xl-4">
                    <div class="blog-box">
                        ...
                        <div class="blog-content">
                            <div class="title-blog">
                                <h3>Ancien blog inexistant n3</h3>
                                <p>Dans ce blog c'est vide</p>
                            </div>
                            <ul class="option-blog">
                                <li><a href="#"><i class="far fa-heart"></i></a></li>
                                <li><a href="#"><i class="fas fa-eye"></i></a></li>
